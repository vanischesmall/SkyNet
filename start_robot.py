...
def send_event():
    ...
    while 1:
        ...
        # if MyJoy.get_joystick_value() is not None:
        data_all.append(MyJoy.get_joystick_value())

        # if MyJoy.get_joystick_value() != 0:
        # print("jjj")
        # data_all.append(MyJoy.get_joystick_value())
...
list_combobox.append(["8", "192.168.137.21", "robot", "l"])
